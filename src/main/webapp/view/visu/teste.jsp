<%-- 
    Document   : teste
    Created on : 01/09/2017, 19:44:41
    Author     : Usuario
--%>
	...
	<div class="main-content">
				...
				<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left"
					...
					<ul class="nav" id="side-menu">
						<li><a href="index.html" class="active"><i
								class="fa fa-home nav_icon"></i>Inicio</a></li>
						<li><a href="#"><i class="fa fa-cogs nav_icon"></i>Importar
								matrículas <span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li><a href="importarMatriculas.jsp">Alunos</a></li>
								<li><a href="media.html">Servidores</a></li>
							</ul></li>

						<li><a href="#"><i class="fa fa-envelope nav_icon"></i>Modulos<span
								class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li><a href="inbox.html">Atribuir módulos <span
										class="nav-badge-btm"></span></a></li>
								<li><a href="compose.html">Cadastrar módulo</a></li>
							</ul></li>

						<li><a href="#"><i class="fa fa-check-square-o nav_icon"></i>Listar
								usuários <span class="fa arrow"></span></a>
							<ul class="nav nav-second-level collapse">
								<li><a href="forms.html">Alunos <span
										class="nav-badge-btm"></span></a></li>
								<li><a href="validation.html">Servidores</a></li>
								<li><a href="validation.html">Todos</a></li>
							</ul></li>

						<li><a href="charts.html" class="chart-nav"><i
								class="fa fa-bar-chart nav_icon"></i>Charts <span
								class="nav-badge-btm pull-right">new</span></a></li>
					</ul>
					<!-- //sidebar-collapse -->
				</nav>
			</div>
		...
		<div class="sticky-header header-section ">
			<div class="header-left">
				...
				<div class="logo">
					<a href="index.html">
						<h1>Sistema</h1> <span><b>Controle de Acesso</b></span>
					</a>
				</div>
				<!--//logo-->
					...
					<div class="col-md-4 social-media widget-shadow">
						<div class="wid-social twitter">
							...
							<div class="social-info">
								<h3
									class="number_counter bold count text-light start_timer counted">3.1
									K</h3>
						...
						<div class="wid-social google-plus">
							...
							<div class="social-info">
								<h3
									class="number_counter bold count text-light start_timer counted">523</h3>
						...
						<div class="wid-social facebook">
							...
							<div class="social-info">
								<h3
									class="number_counter bold count text-light start_timer counted">1.06K</h3>
						...
						<div class="wid-social dribbble">
							...
							<div class="social-info">
								<h3
									class="number_counter bold count text-light start_timer counted">1.6
									K</h3>
						...
						<div class="wid-social vimeo">
							...
							<div class="social-info">
								<h3
									class="number_counter bold count text-light start_timer counted">2.1
									m</h3>
						...
						<div class="wid-social xing">
							...
							<div class="social-info">
								<h3
									class="number_counter bold count text-light start_timer counted">2525</h3>
						...
						<div class="wid-social flickr">
							...
							<div class="social-info">
								<h3
									class="number_counter bold count text-light start_timer counted">1221</h3>
						...
						<div class="wid-social rss">
							...
							<div class="social-info">
								<h3
									class="number_counter bold count text-light start_timer counted">1523</h3>
								<h4 class="counttype text-light">Subscribers</h4>
							</div>
						</div>
		...
		<div class="footer">
			<p>
				&copy; 2017 N2S - Todos os direitos reservados | Design by <a
