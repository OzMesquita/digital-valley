<%-- 
    Document   : style
    Created on : 01/09/2017, 17:22:24
    Author     : Usuario
--%>
...
<!--//webfonts--> 
<!--animate-->
<link href="visu/css/animate.css" rel="stylesheet" >
...
<!-- //chart -->
<!--Calender-->
<link rel="stylesheet" href="visu/css/clndr.css" type="text/css" />
<script src="visu/js/underscore-min.js" type="text/javascript"></script>
<script src= "visu/js/moment-2.2.1.js" type="text/javascript"></script>
<script src="visu/js/clndr.js" type="text/javascript"></script>
<script src="visu/js/site.js" type="text/javascript"></script>
<!--End Calender-->
<!-- Metis Menu -->
