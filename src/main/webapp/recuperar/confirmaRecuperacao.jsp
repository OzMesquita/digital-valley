      ...
      <div class="row row-full-height">
        ...
        <div class="col-sm-6 col-md-4 col-full-height login-form">
          <div>	
                ...
                <form class="form-horizontal" role="form" action="ConfirmaRecuperacao" name="formVerifica" method="post">
                	<%
					...
					<div id="form-aluno">
	                    ...
	                    <div class="form-group">
	                        <div class="col-sm-12 col-sm-offset-1">
	                            <input type="text" name="cpfA" class="form-control" id="inputPassword3" placeholder="CPF, ex.: 123.456.789-10">
	                        </div>
	                    </div>
					</div>
					<div id="form-servidor" style="display:none;">
	                    ...
	                    <div class="form-group">
	                        <div class="col-sm-12 col-sm-offset-1">
	                            <input type="text" name="cpfS" class="form-control" id="inputPassword3" placeholder="CPF, ex.: 123.456.789-10" >
	                        </div>
	                    </div>
					</div>
                    <div class="form-group">
